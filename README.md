...
```bash
crypton-sweep report examples/industry-fleet-synthetic.json \
  --out reports/industry-fleet-synthetic.html
crypton-sweep serve examples/industry-fleet-synthetic.json \
